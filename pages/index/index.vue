<template>
  <view class="content" disable-scroll="true">
    <view class="user-layer" v-if="!showSheet">
      <image :src="userInfo.avatarUrl" class="user-post" @click="goUser"/>
      <view class="text">欢迎使用起电！</view>
      <button class="shop" @click="goNearShop">
        <view class="icon icon-shop"></view>附件商家
      </button>
    </view>
    <view class="task">
      <icon class="battery icon-battery" />
      <view class="info">
        <view class="top">1个订单租借中……</view>
        <view class="bottom">可归还至其他商家</view>
      </view>
      <button class="more" @click="goShopDetail">查看详情</button>
    </view>
    <view class="option-scan" @click="scanCode">
      <view class="icon icon-scan"></view>扫一扫借用
    </view>
    <view class="right-option">
      <view class="location" @click="goLocation">
        <view class="icon-location"></view>
      </view>
      <view class="call-me" @click="callMe">
        <view class="icon icon-call"></view>
      </view>
    </view>
    ...
    <view class="store-box">
      <shopItem :show="showShopItem" :item="shopItemData" />
    </view>
  </view>
</template>
